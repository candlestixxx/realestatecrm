    ...
    <>
      ...
      <Dialog.Root open={open} onOpenChange={setOpen}>
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed inset-0 z-50 flex items-start justify-center pt-[20vh] p-4 pointer-events-none focus:outline-none">
            <Dialog.Title className="sr-only">Search CRM</Dialog.Title>
            <Dialog.Description className="sr-only">Quick search for leads, contacts, deals, and tasks</Dialog.Description>
            <div className="w-full max-w-2xl pointer-events-auto">
              <Command
                className="w-full bg-card border border-border shadow-2xl rounded-xl overflow-hidden"
                shouldFilter={false}
                loop
              >
